...
/**
 * Default implementation of the {@link BeanDefinitionDocumentReader} interface that reads bean definitions according to the "spring-beans" DTD and XSD format (Spring's default XML
 * bean definition format).
 *
 * <p>
 * The structure, elements, and attribute names of the required XML document are hard-coded in this class. (Of course a transform could be run if necessary to produce this format).
 * {@code <beans>} does not need to be the root element of the XML document: this class will parse all bean definition elements in the XML file, regardless of the actual root
 * element.
 *
 * @author Rod Johnson
...
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader
{
	...
	{
		// 如果beans未写命名空间或使用了"http://www.springframework.org/schema/beans"，
		// 则为默认命名空间
	...
	/**
	 * Allow the XML to be extensible by processing any custom element types first, before we start to process the bean definitions. This method is a natural extension point for
	 * any other custom pre-processing of the XML.
	 * <p>
	 * The default implementation is empty. Subclasses can override this method to convert custom elements into standard Spring bean definitions, for example. Implementors have
	...
	/**
	 * Allow the XML to be extensible by processing any custom element types last, after we finished processing the bean definitions. This method is a natural extension point for
	 * any other custom post-processing of the XML.
	 * <p>
	 * The default implementation is empty. Subclasses can override this method to convert custom elements into standard Spring bean definitions, for example. Implementors have
	 * access to the parser's bean definition reader and the underlying XML resource, through the corresponding accessors.
	 * 

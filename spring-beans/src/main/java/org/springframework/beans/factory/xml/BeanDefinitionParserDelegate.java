...
/**
 * Stateful delegate class used to parse XML bean definitions. Intended for use by both the main parser and any extension {@link BeanDefinitionParser BeanDefinitionParsers} or
...
public class BeanDefinitionParserDelegate
{
	...
	/**
	 * Stores all used bean names so we can enforce uniqueness on a per beans-element basis. Duplicate bean ids/names may not exist within the same level of beans element nesting,
	 * but may be duplicated across levels.
	 */
	...
	/**
	 * Initialize the default lazy-init, autowire, dependency check settings, init-method, destroy-method and merge settings. Support nested 'beans' element use cases by falling
	 * back to the given parent in case the defaults are not explicitly set locally.
	 * 
	 ...
	 * Support nested 'beans' element use cases by falling back to <literal>parentDefaults</literal> in case the defaults are not explicitly set locally.
	 * 
	...
	/**
	 * Return the defaults definition object, or {@code null} if the defaults have been initialized yet.
	 */
	...
	/**
	 * Get the namespace URI for the supplied node. The default implementation uses {@link Node#getNamespaceURI}. Subclasses may override the default implementation to provide a
	...
	/**
	 * Ges the local name for the supplied {@link Node}. The default implementation calls {@link Node#getLocalName}. Subclasses may override the default implementation to provide a
